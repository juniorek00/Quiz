...
interface SegmentBreakProps {
  onContinue: () => void;
}

const SegmentBreak: React.FC<SegmentBreakProps> = ({ onContinue }) => {
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-center space-y-8">
        ...
        <p className="text-2xl text-gray-300">Przygotuj się na kolejną rundę1</p>
        <button
          onClick={onContinue}
